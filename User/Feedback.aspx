<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site1.Master" AutoEventWireup="true" CodeBehind="Feedback.aspx.cs" Inherits="Amsement_park1.User.WebForm12" %>
                ...
                <form id="mailchimp-subscription-form" class="newsletter-form mt-0 mb-30 maxwidth500">
                  ...
                  <div class="input-group">
                    <%--<input type="email" id="mce-EMAIL" data-height="45px" class="form-control input-lg" placeholder="Your Feedback" name="EMAIL" value="">--%>
                      <asp:TextBox ID="txtsms"   data-height="45px" class="form-control input-lg" placeholder="Your Feedback"  value="" runat="server"></asp:TextBox>
