<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeFile="Waterpark.aspx.cs" Inherits="Amsement_park1.Admin.WebForm18" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- END PAGE LEVEL CUSTOM STYLES -->
    <a href="Waterpark.aspx">Waterpark.aspx</a>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Ridecategory.aspx">Ride Category</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>WaterPark Ride</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                ...
                <form runat="server">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12 mx-auto">
                                        ...
                                        <div class="form-group mb-4">
                                            <%--<input type="email" class="form-control" id="rEmail" placeholder="Email address *">--%>
                                            <label for="fullName">Water Ride Category</label>
                                            <asp:DropDownList ID="DropDownList1" runat="server" class="form-control  basic" DataSourceID="SqlDataSource2" DataTextField="wrcname" DataValueField="wrcid"></asp:DropDownList>

                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [waterridecategory]"></asp:SqlDataSource>
                                        </div>

                                        <div class="form-group mb-4">
                                            <%--<input type="password" class="form-control" id="rPassword" placeholder="Password *">--%>
                                            <label for="fullName">Waterpark Ride Name</label>
                                            <asp:TextBox ID="txtwname" runat="server" class="form-control" required="plese"></asp:TextBox>
                                        </div>
                                        <div class="form-group mb-4">
                                        ...
                                        <asp:Button ID="Btn_water" runat="server" class="btn btn-primary mt-3" Text="Submit" OnClick="Btn_water_Click" />
                    ...
                    <div id="Watertable" class="col-lg-12 layout-spacing" style="left: 1px; top: 5px">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="">
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT Waterpark.waterrideid, Waterpark.Ridecatid, Waterpark.wrcid, Waterpark.ridename, Waterpark.rideimg, Waterpark.ridediscription, Waterpark.status, waterridecategory.wrcid AS Expr1, waterridecategory.wrcname, waterridecategory.pic, Ride_category.Ridecatid AS Expr2, Ride_category.ddlridecategory FROM Waterpark INNER JOIN waterridecategory ON Waterpark.wrcid = waterridecategory.wrcid INNER JOIN Ride_category ON Waterpark.Ridecatid = Ride_category.Ridecatid"></asp:SqlDataSource>
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource3">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("ridename") %></td>
                                            <td>
                                                <img src='../Waterparkridepic/<%#Eval("rideimg") %>' height="100" width="100" />
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                        <a class="dropdown-item" href="UpdateWater.aspx?waterrideid=<%#Eval("waterrideid") %>">Update</a>
                                                        <a class="dropdown-item" href="DeleteWater.aspx?waterrideid=<%#Eval("waterrideid") %>">Delete</a>
