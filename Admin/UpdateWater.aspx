<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UpdateWater.aspx.cs" Inherits="Amsement_park1.Admin.WebForm20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container">
                <br/>
            <center><h4>Update Water</h4></center>
                                    ...
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <form method="post" runat="server">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                <h4>Water Ride Name</h4>
                                                <label for="t-text" class="sr-only">Text</label>
                                                <%--<input id="t-text" type="text" name="txt" placeholder="Your Country Name..." class="form-control" required="">--%>
                                                <asp:TextBox ID="txtWater" placeholder="Your Water Ride Name..." class="form-control" required="" runat="server"></asp:TextBox>
