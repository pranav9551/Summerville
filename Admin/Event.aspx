<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Event.aspx.cs" Inherits="Amsement_park1.Admin.WebForm24" %>
        ...
        <div class="">
            ...
            <div class="container">
                ...
                <form runat="server">
                    ...
                    <div class="col-lg-12 layout-spacing">
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12 mx-auto" style="left: 0px; top: 0px">

                                        <div class="form-group mb-4">
                                            <%--<input type="password" class="form-control" id="rPassword" placeholder="Password *">--%>
                                            <label for="fullName">Event Name</label>
                                            <asp:TextBox ID="txtename" runat="server" class="form-control" required="plese"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div>
                                                <label for="fullName">Upload Event Image</label>
                                            </div>
                                            <div class="custom-file" style="left: 0px; top: 0px">
                                        ...
                                        <div class="form-group mb-4">
                                            <%--<input type="password" class="form-control" id="rPassword" placeholder="Password *">--%>
                                            <div>
                                                <label for="fullName">Event Descriptions</label>
                                            </div>
                                        ...
                                        <asp:Button ID="Btn_event" runat="server" class="btn btn-primary mt-3" Text="Submit" OnClick="Btn_event_Click" />
                                        <br/>
                                        <br/>
                                    </div>
                                </div>
                    ...
                    <%--END INSERT EVENT CATEGORY --%>

                    <%--BEING EVENT TABLE--%>

                    <div id="eventtable" class="col-lg-12 layout-spacing" style="left: 1px; top: 5px">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td class="checkbox-column text-center sorting_1"><%#Eval("eid") %></td>
                                            <td><%#Eval("ename") %></td>
                                            <td>
                                                <img src='../eventpic/<%#Eval("epic") %>' height="100" width="100" />
                                            </td>
                                            <td><%#Eval("edate") %></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                        <a class="dropdown-item" href="Updateevent.aspx?eid=<%#Eval("eid") %>">Update</a>
                                                        <a class="dropdown-item" href="Deleteevent.aspx?eid=<%#Eval("eid") %>">Delete</a> 
