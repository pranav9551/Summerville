<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" Codefile="UpdateTheme.aspx.cs" Inherits="Amsement_park1.Admin.WebForm2" %>
                                    ...
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <form method="post" runat="server">
                                            ...
                                            <div class="form-group">
                                                <h4>Theme Ride Name</h4>
                                                <label for="t-text" class="sr-only">Text</label>
                                                <%--<input id="t-text" type="text" name="txt" placeholder="Your Country Name..." class="form-control" required="">--%>
                                                <asp:TextBox ID="txttheme" placeholder="Your Theme Ride Name..." class="form-control" required="" runat="server"></asp:TextBox>
